...
//    CGSize tempSize = MB_TEXTSIZE(label.text, label.font);
    CGSize labelSize = [label.text boundingRectWithSize:CGSizeMake(maxWidth, IPHONE_HEIGHT-200) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:label.font} context:nil].size;
